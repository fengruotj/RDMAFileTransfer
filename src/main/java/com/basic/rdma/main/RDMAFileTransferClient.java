...
public class RDMAFileTransferClient implements RdmaEndpointFactory<RDMAFileTransferClient.CustomClientEndpoint> {
    ...
    public void run() throws Exception {
        ...
        FileOutputStream fout = new FileOutputStream("/home/zhanyang/rec.log");
        ...
        for(int i=0;i<100000;i++) {
            ...
            postSend.getWrMod(0).getSgeMod(0).setLength(100);
            postSend.execute();
            ...
            bw.write(dataBuf.asCharBuffer().toString());
